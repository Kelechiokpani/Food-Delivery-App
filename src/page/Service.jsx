...
const Service = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center">
      <section className=" service-hero  grid gap-2 w-[100rem]">
        <div className=" py-2 flex-1 flex items-center relative w-full justify-center ">
          <p className="text-[2rem] lg:text-[4.2rem] font-bold tracking-wide text-orange-600">
            Our
            <span
